...
- **Monorepo Structure**: See `.claude/skills/software-architecture/references/monorepo.md`
- **NextJS Patterns**: See `.claude/skills/software-architecture/references/nextjs-patterns.md`
- **Testing Standards**: See `.claude/skills/software-architecture/references/testing.md`
- **Code Style**: See `.claude/skills/software-architecture/references/code-style.md`
- **Anti-patterns**: See `.claude/skills/software-architecture/references/anti-patterns.md`
...
This agent references detailed documentation for specific architectural domains:
